import { CTAContent } from "@/sections/CTASection/components/CTAContents";

export const CTASection = () => {
  return (
    <div className="box-border caret-transparent break-words pt-8 pb-16 px-4 md:px-12 md:py-24">
